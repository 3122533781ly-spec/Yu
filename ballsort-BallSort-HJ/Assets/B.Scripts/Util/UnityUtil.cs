...
public static class UnityUtil
{
    ...
    public static int NumberFloorToInt(float number)
    {
    ...
    {
        CanvasGroup canvasGroup = go.GetComponent<CanvasGroup>() ?? go.AddComponent<CanvasGroup>();
    ...
    public static void SetActiveVirtual(this GameObject gameObject, bool isActive)
    {
        if (!gameObject)
        {
            return;
    ...
    public static void SetActiveVirtual<T>(this T component, bool value) where T : MonoBehaviour
    {
        if (!component)
        {
            return;
