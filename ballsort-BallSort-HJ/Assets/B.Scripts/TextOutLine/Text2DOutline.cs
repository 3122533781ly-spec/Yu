...
[AddComponentMenu("UI/Effects/Text2DOutline")]
...
public class Text2DOutline : BaseMeshEffect
{
    ...
    [Header("描边宽度"), Range(0, 10)] [SerializeField]
    ...
    [Header("阴影描边宽度"), Range(0, 10)] [SerializeField]
...
#pragma warning restore 0114
    ...
    public void Refresh(string color, int widht)
    {
        outlineColor = UtilClass.HexToColor(color);
        outlineColor.a = 1;
        outlineWidth = widht;
        _Refresh();
    }
    ...
    /// <param name="color"></param>
    /// <param name="widht"></param>
    public void Refresh(Color color, int widht)
    {
        outlineColor = color;
        outlineColor.a = 1;
        outlineWidth = widht;
