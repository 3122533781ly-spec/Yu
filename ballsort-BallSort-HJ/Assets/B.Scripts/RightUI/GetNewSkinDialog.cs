...
public class GetNewSkinDialog : Dialog
{
    public Image icon;
    ...
    public void Init(GoodType type, int id, Sprite skinSprite, int subType)
    {
        this.type = type;
        useId = id;
    ...
    public void UseSkin()
    {
        DialogManager.Instance.GetDialog<DressUpDialog>().UseSkin(type, useId);
